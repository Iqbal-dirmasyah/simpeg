...
(function () {
    ...
    var each = (helpers.each = function (loopable, callback, self) {
            ...
            if (loopable) {
                if (loopable.length === +loopable.length) {
                    ...
                    for (i = 0; i < loopable.length; i++) {
                        callback.apply(
                            self,
                            [loopable[i], i].concat(additionalArgs)
                        );
                    }
                } else {
                    for (var item in loopable) {
                        callback.apply(
                            self,
                            [loopable[item], item].concat(additionalArgs)
                        );
                    }
                }
            }
        ...
        animationLoop = (helpers.animationLoop = function (
            ...
            var currentStep = 0,
                easingFunction =
                    easingEffects[easingString] || easingEffects.linear;
        ...
        removeEvent = (helpers.removeEvent = function (
            node,
            eventType,
            handler
        ) {
        ...
        longestText = (helpers.longestText = function (
            ctx,
            font,
            arrayOfStrings
        ) {
    ...
    extend(Chart.Element.prototype, {
        ...
        transition: function (props, ease) {
            each(
                ...
                function (value, key) {
                    this[key] =
                        (value - this._saved[key]) * ease + this._saved[key];
                },
                this
            );
            return this;
    ...
    Chart.Tooltip = Chart.Element.extend({
        draw: function () {
            ...
            var tooltipWidth =
                ...
                tooltipHeight =
                    tooltipRectHeight + this.caretHeight + caretPadding;
            ...
            if (this.custom) {
                ...
                switch (this.xAlign) {
                    ...
                    case "right":
                        tooltipX =
                            this.x - (this.cornerRadius + this.caretHeight);
                        break;
                }
    ...
    Chart.MultiTooltip = Chart.Element.extend({
        initialize: function () {
            ...
            var titleWidth = this.ctx.measureText(this.title).width,
                ...
                labelWidth =
                    longestText(this.ctx, this.font, this.labels) +
                    this.fontSize +
                    3,
        ...
        getLineHeight: function (index) {
            ...
            if (index === 0) {
                ...
                return (
                    baseLineHeight +
                    (this.fontSize * 1.5 * afterTitleIndex +
                        this.fontSize / 2) +
                    this.titleFontSize * 1.5
                );
            }
    ...
    Chart.Scale = Chart.Element.extend({
        ...
        calculateXLabelRotation: function () {
            ...
            if (this.display) {
                var originalLabelWidth = longestText(
                        this.ctx,
                        this.font,
                        this.xLabels
                    ),
                ...
                if (this.xLabelRotation > 0) {
                    this.endPoint -=
                        Math.sin(toRadians(this.xLabelRotation)) *
                            originalLabelWidth +
                        3;
                }
            } else {
            ...
            if (this.display) {
                ...
                each(
                    ...
                    function (label, index) {
                        ...
                        if (index > 0) {
                            var yCenterOffset =
                                    index * (this.drawingArea / this.steps),
        ...
        draw: function (easeDecimal) {
            ...
            helpers.each(
                ...
                function (segment, index) {
                    ...
                    segment.endAngle =
                        segment.startAngle + segment.circumference;
        ...
        draw: function (ease) {
            ...
            var hasValue = function (item) {
                ...
                nextPoint = function (point, collection, index) {
                    return (
                        helpers.findNextWhere(collection, hasValue, index) ||
                        point
                    );
                },
            ...
            helpers.each(
                this.datasets,
                function (dataset) {
                    var pointsWithValues = helpers.where(
                        dataset.points,
                        hasValue
                    );
                    ...
                    if (this.options.bezierCurve) {
                        helpers.each(
                            ...
                            function (point, index) {
                                var tension =
                                    index > 0 &&
                                    index < pointsWithValues.length - 1
