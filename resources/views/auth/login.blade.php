...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('img/PKSDM.png')}}" style="width:50px;" alt="User Image">
        <div>
          <p class="app-sidebar__user-name"></p>
          <p class="app-sidebar__user-designation" style="font-size: 24px;"><b>BKPSDM DEPOK</b></p>
        </div>
      </div>
      <div class="login-box">
