...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="/img/PKSDM.png">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('img/PKSDM.png')}}" width="60px" style="margin-left: 10px;" alt="User Image">
        <div>
          <p class="app-sidebar__user-name"></p>
          <h6 class="app-sidebar__user-designation">BKPSDM DEPOK</h6>
        </div>
      </div>
      <ul class="app-menu">
        ...
        <li class="treeview {{ request()->is('agama','negara','darah','keluarga') ? 'is-expanded' : '' }}">
          ...
          <ul class="treeview-menu">
            <li><a style="    background: #fff;" class="treeview-item {{ request()->is('agama') ? 'active' : '' }}" href="{{route('agama.index')}}"><i class="icon fa fa-circle-o"></i> Agama</a></li>
            <li><a style="    background: #fff;" class="treeview-item {{ request()->is('negara') ? 'active' : '' }}" href="{{route('negara.index')}}"><i class="icon fa fa-circle-o"></i> Kewarganegaraan</a></li>
            <li><a style="    background: #fff;" class="treeview-item {{ request()->is('darah') ? 'active' : '' }}" href="{{route('darah.index')}}"><i class="icon fa fa-circle-o"></i> Golongan Darah</a></li>
            <li><a style="    background: #fff;" class="treeview-item {{ request()->is('keluarga') ? 'active' : '' }}" href="{{route('keluarga.index')}}"><i class="icon fa fa-circle-o"></i> Status</a></li>
          </ul>
        </li>
        <li class="treeview {{ request()->is('pegawai','pegawai/*') ? 'is-expanded' : '' }}">
          ...
          <ul class="treeview-menu">
            <li><a style="    background: #fff;" class="treeview-item {{ request()->is('pegawai') ? 'active' : '' }}" href="{{route('pegawai.index')}}"><i class="icon fa fa-circle-o"></i> Data Pegawai</a></li>
            <li><a style="    background: #fff;" class="treeview-item {{ request()->is('pegawai/create') ? 'active' : '' }}" href="{{route('pegawai.create')}}" target="" rel="noopener"><i class="icon fa fa-circle-o"></i> Tambah Pegawai</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Rekap Data</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a style="  background: #fff;" class="treeview-item" href="{{route('pegawai-pdf')}}"><i class="icon fa fa-circle-o"></i> Pegawai</a></li>
          </ul>
        </li>
      </ul>
    </aside>
